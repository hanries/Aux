...
enum RoomConfig {
    ...
    /// Per-room audience cap — small + intimate (built for genuine connection);
    /// overflow routes to a new instance. Keep in sync with join_category's v_cap.
    static let roomCap = 7
